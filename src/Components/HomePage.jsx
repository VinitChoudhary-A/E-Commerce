    ...
    return (
        <div className='flex flex-col  h-screen overflow-hidden relative'>
            ...
            <div className="absolute z-10">
                ...
                <div className='flex flex-row w-2/3 sm:w-[10%] md:w-2/3 lg:w-1/3'>
                    <div className='flex flex-col   w-full  justify-center mt-54 lg:mt-34 ms-10 '>
                        ...
                        <div className='flex   flex-row justify-center items-center rounded-full mt-4 gap-15 lg:gap-5 mb-4 bg-gray-100/50 pb-2 lg:px-30   backdrop-blur-md h-fit '>
                            <button onClick={()=>{navigate('/browse')}} className='bg-blue-100 hidden sm:block text-black lg:px-3 px-4 py-1 cursor-pointer  rounded-full mt-4'>Browse</button>
                            ...
                            <button onClick={()=>{window.open(githubLink, '_blank')}} className='hidden 
                            bg-white sm:block text-black lg:px-3 px-4 py-1 cursor-pointer rounded-full mt-4'>Github</button>
